...
// route to the emptyTemplate
Router.route('/', {name: 'emptyTemplate'});
...
Router.route('/timeBased/yearly', {
	name: 'yearlyTimed',
	data: function() {
		var currentDate = new Date();
		return {
			queryMonth: this.params.query.month || currentDate.getMonth()+1,
			queryYear: this.params.query.year || currentDate.getFullYear()
		};
	}
});
...
Router.route('/listView/yearly', {name: 'yearlyList'});
